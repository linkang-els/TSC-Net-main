...
def write_to_file(dname, dmap, cmap, itr,mAP_avg_all, mAP_avg_0_1_0_5, mAP_avg_0_1_0_7):
    ...
    string_to_write += " " + "%.2f" % mAP_avg_all
    string_to_write += " " + "%.2f" % mAP_avg_0_1_0_5
    string_to_write += " " + "%.2f" % mAP_avg_0_1_0_7
